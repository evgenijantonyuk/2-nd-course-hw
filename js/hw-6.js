...
console.log(`Массив случайных чисел от 0 до: ${randomTask6} - ${randomArray(randomTask6)}`)
...
const randomNumberTask7 = (numberOneTask7, numberTwoTask7) => {
  return Math.floor(Math.random() * (numberOneTask7 - numberTwoTask7 + 1) + numberTwoTask7)
}
console.log(`Число в диапазне чисел ${numberOneTask7} и ${numberTwoTask7}: ${randomNumberTask7(numberOneTask7, numberTwoTask7)}`)
...
do {
    ...
    if (guess === null) {
        alert("❌Игра окончена. Вы сдались! Загаданное число было: " + secretNumber)
        break
    }
